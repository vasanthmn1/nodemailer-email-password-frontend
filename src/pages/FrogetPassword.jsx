...
import { resetPasswordApiRoute } from '../apis/Apis'
const FrogetPassword = () => {
    ...
    let myFormik = useFormik({
        ...
        onSubmit: async (values) => {
            try {
                const { data } = await axios.post(`${resetPasswordApiRoute}`, values)
                toast.success("Token send SuccessFull")
    ...
    return (
        <div className='container'>
            ...
            <p className='text-red-500'>Frogot-password</p>
            ...
            <form onSubmit={myFormik.handleSubmit}>
                ...
                <button type='submit' className='bg-cyan-800 text-white cursor-pointer'>Verify</button>
            </form>
